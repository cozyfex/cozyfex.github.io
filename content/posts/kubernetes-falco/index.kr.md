...
우리는 크래커에 의한 의도되지 않은 syscalls 실행에 대한 알림을 받아야 한다.  
그래서 우리는 이를 위한 시스템을 구축해야 한다.  
{{</admonition>}}

## Falco

{{<admonition note Falco true>}}  
클라우드 네이티브 런타임 보안 프로젝트인 [Falco](https://falco.org)는 사실상 Kubernetes 위협 탐지 엔진입니다.  
{{</admonition>}}
...
[Helm](https://helm.sh), Kubernetes 패키지 매니저 입니다.  
{{</admonition>}}
